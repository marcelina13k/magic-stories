...
const characterInfo = {
  ...
  imageUrl: "C:\Users\mkrow\iCloudPhotos\Photos\Pictures\Screenshots\charlie-avatar.png", // Updated to use local path
}
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="md:self-center">
              <AudioPlayer
                src="C:\Users\mkrow\Downloads\charlie-audio.mp3" // Updated to use local path
